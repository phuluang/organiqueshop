<?php
    class ControllerSimpleBlogReport extends Controller {
    	...
    	public function getData() {
			...
			$data['sort_article_title'] = $this->url->link('simple_blog/report', 'token=' . $this->session->data['token'] . '&sort=sbad.article_title' . $url, 'SSL');
			$data['sort_author_name'] = $this->url->link('simple_blog/report', 'token=' . $this->session->data['token'] . '&sort=sbau.name' . $url, 'SSL');
			$data['sort_view'] = $this->url->link('simple_blog/report', 'token=' . $this->session->data['token'] . '&sort=sbv.view' . $url, 'SSL');			
    		...
    		$this->response->setOutput($this->load->view('simple_blog/report.tpl', $data));
    	}
    }
?>