			          			        ...
			          			        <?php foreach($articles as $article) { ?>
                                            <tr>
                                                <td class="text-center">
                                                    <?php if (in_array($article['simple_blog_article_id'], $selected)) { ?>
                                                ...
                                                <td class="text-left"><?php echo $article['article_title']; ?></td>
        	            						<td class="text-left"><?php echo $article['author_name']; ?></td>
        	            						<td class="text-right"><?php echo $article['sort_order']; ?></td>
                        						<td class="text-left"><?php echo $article['status']; ?></td>
                        						<td class="text-right"><?php echo $article['date_added']; ?></td>
                                                <td class="text-right">
